	...
	<div class="akeeba-container--50-50">
		...
		<div class="akeeba-panel--orange">
			...
			<?php if ($this->htaccessSupported): ?>
                ...
                <div class="akeeba-form-group--checkbox--pull-right">
                    <label <?php echo $this->removeAddHandlerOptions['disabled'] ?>>
                        <input type="checkbox" value="1" id="removeaddhandler"
                               name="removeaddhandler" <?php echo $this->removeAddHandlerOptions['disabled'] ?> <?php echo $this->removeAddHandlerOptions['checked'] ?> />
						<?php echo AText::_('SETUP_LBL_SERVERCONFIG_REMOVEADDHANDLER'); ?>
                    </label>
                    <span class="akeeba-help-text" style="display: none">
						  <?php echo AText::_($this->removeAddHandlerOptions['help']) ?>
					</span>
                </div>
			<?php endif; ?>
            ...
            <div class="akeeba-form-group--checkbox--pull-right">
                <label>
                    <input type="checkbox" value="1" id="disableForceSSL" name="disableForceSSL"/>
                    <?php echo AText::_('SETUP_LBL_SERVERCONFIG_DISABLEFORCESSL'); ?>
                </label>
            </div>
		</div>
	</div>
